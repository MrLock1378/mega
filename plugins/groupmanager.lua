...
—----------------
_دستورات سرگرمی_
:_توجه ممکن است دستورات کار نکند_
*!joke*
_ارسال جک برای شما بصورت تصادفی_
*!fal*
_🔮گرفتن فال حافظ لطفا ابتدا نیت کنید 🔮_
*!loc +*
_گرفتن مکان دقیق شما _
*in kie*
_برای اطلاع از مقام کسی این عبارت با را ارسال کنید
*!me*
_اطلاع از تعداد پیام های ارسالی و دریافت ایدی_
—----------------
🔊دستورات فان و تولز!🍃
!helpfun
------------
